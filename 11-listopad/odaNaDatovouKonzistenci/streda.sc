...
{
var amp = 0.2;
var fq = XLine.kr(720,90,680) * SinOsc.ar(72.333,0,1.0);
[Decay.ar(Impulse.ar(XLine.kr(0.1,5000,590), 0.25), 3, SinOsc.ar(fq*6,0,amp), 0.8),Decay.ar(Impulse.ar(XLine.kr(0.11,5000,610), 0.25), 3, SinOsc.ar(fq*3,0,amp ), 0.8)]  }.play;
...
//// filtr //////////////////////
(
{var amp = SinOsc.ar(10.rand*0.001,0,0.1);
